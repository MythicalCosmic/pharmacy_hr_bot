...
from bot.handlers.main import language_selection, menu_handler, settings_handler, personal_info_handler, student_info_handler, work_experience_hander, confirmation_handlers, photo_handlers, last_handlers
